...
const campaigns = [
  { name: "Shopping", revenue: 42840, roas: 5.2, contribution: 28, confidence: 89.1, trend: "up", change: "+4.2%" },
  { name: "Search", revenue: 33660, roas: 4.1, contribution: 22, confidence: 87.3, trend: "up", change: "+2.8%" },
  { name: "PMAX", revenue: 27540, roas: 3.9, contribution: 18, confidence: 84.5, trend: "up", change: "+6.1%" },
  { name: "Retargeting", revenue: 15300, roas: 7.1, contribution: 10, confidence: 91.2, trend: "up", change: "+1.5%" },
  { name: "Display", revenue: 12240, roas: 1.8, contribution: 8, confidence: 78.9, trend: "down", change: "-3.2%" },
  { name: "Video", revenue: 9180, roas: 2.3, contribution: 6, confidence: 82.1, trend: "up", change: "+5.4%" },
  { name: "Prospecting", revenue: 7650, roas: 2.0, contribution: 5, confidence: 76.8, trend: "down", change: "-1.8%" },
  { name: "Brand", revenue: 4590, roas: 12.5, contribution: 3, confidence: 93.4, trend: "up", change: "+0.9%" },
];
        ...
        {campaigns.map((c, i) => (
          ...
          >
            ...
            <div className="flex items-center justify-between text-sm">
              <span className="text-[hsl(var(--muted-foreground))]">ROAS: <span className="font-mono-numbers font-medium text-[hsl(var(--foreground))]">{c.roas}x</span></span>
